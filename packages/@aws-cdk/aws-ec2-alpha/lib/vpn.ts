...
import { Token, ValidationError } from "aws-cdk-lib";
import * as cloudwatch from 'aws-cdk-lib/aws-cloudwatch';
import { VpnConnectionBase, VpnConnectionAttributes, IVpnConnection, VpnConnectionType, CfnCustomerGateway, RESERVED_TUNNEL_INSIDE_CIDR, CfnVPNConnection, CfnVPNConnectionRoute, VpnConnectionOptions } from "aws-cdk-lib/aws-ec2";
  ...
  constructor(scope: Construct, id: string, props: VpnConnectionProps) {
    ...
    const vpnConnection = new CfnVPNConnection(this, 'Resource', {
      ...
      vpnTunnelOptionsSpecifications: props.tunnelOptions?.map(t => ({
        preSharedKey: t.preSharedKeySecret?.unsafeUnwrap(),
